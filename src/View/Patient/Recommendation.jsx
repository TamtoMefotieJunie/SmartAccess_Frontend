          ...
          <Table>
            <TableHead style={{ backgroundColor: '#f5f5f5' }}>
              <TableRow>
                ...
                <TableCell><strong>Recommended Hospital</strong></TableCell>
                <TableCell><strong>Specialty</strong></TableCell>
                <TableCell align=""><Directions fontSize="small" /> <strong>Route</strong></TableCell>
                <TableCell align="center"><AccessTime fontSize="small" /> <strong>Time</strong></TableCell>
            ...
            <TableBody>
              {emergencyRecommendations.map((rec) => (
                <TableRow key={rec._id} hover>
                  <TableCell>
                    <Chip label={rec.patient_encounter?.case || 'Emergency'} color="error" size="small" />
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center">
                      <Place color="action" fontSize="small" className="mr-1" />
                      {rec.recommended_hospital?.name || 'N/A'}
                    </div>
                  </TableCell>
                  <TableCell>{rec.recommended_specialty_offering?.name || 'General'}</TableCell>
                  <TableCell align="center">{rec.recommended_route_distance?.toFixed(1)} km</TableCell>
                  <TableCell align="center">{rec.recommended_route_time_min} min</TableCell>
                  <TableCell>
                    <Chip 
